...
<head profile="http://gmpg.org/xfn/11">
    ...
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/jquery.cycle.css", true);?>
    ...
    <!-- Load Pretty Photo -->
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/prettyPhoto.css", true);?>
    ...
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/jquery.roundabout.css", true);?>
